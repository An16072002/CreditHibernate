...
public class Student2 extends Human {
	...
	public Student2(String code, String fullname, String address, String class_) {
	...
	*/
	...
	public static void main(String[] args) {
		...
		*/
		Student2 std = new Student2("669030","Nguyen Duc Nam", "Ha Noi", "K66CNTTA");
		Term2 t1 = new Term2("2022-2023");
